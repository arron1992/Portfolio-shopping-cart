                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 footer-box">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="footer-link">Sponserships</a></li>
                    ...
                    <div class="col-md-3 col-sm-12 footer-box">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="footer-link">Mail: Dr.boom@gmial.com</a></li>
                    ...
                    <div class="col-md-3 col-sm-12 footer-box">
                        ...
                        <ul class="icon-group">
                            ...
                            <li><a href="#"><i class="far fa-envelope-open fa-2x"></i></a></li>
                        </ul>
                    </div>
                    <p class="copright">©Copright 2019 Chang-tzu-shuan</p>   
                </div>
            </div>
        </footer>
    </div>
