    ...
    <div class="row product-group">
      ...
      <div class="col-3" style="padding-left:0px;">
          <ul class="select-list">
            ...
            <li v-for="(item) in categories" class="select-list-item" :key="item.id"
      ...
      <div class="col-9" style="padding-right:0px;">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-12 " v-for="item in filterData[currentPage]" :key="item.id">
            <div class="card">
                <a href="#" class="card-head" :style="{backgroundImage:`url(${item.image})`}"></a>
                <div class="card-body">
                    <h5><span class="badge badge-pill badge-info">{{item.category}}</span></h5>
        ...
        <ul class="page-list">
          <li>
            <a href="#" class="page-list-item" :class="{'noHover':currentPage === 0}"
              @click.prevent="currentPage = currentPage - 1">&laquo;
            </a>
          </li>
          ...
          <li v-for="page in filterData.length" :key="page">
            <a href="#"
              ...
              class="page-list-item" >{{page}}
            </a>
          </li>

          <li>
            <a href="#" class="page-list-item" :class="{'noHover': currentPage === filterData.length - 1}"
            @click.prevent="currentPage = currentPage + 1">&raquo;
            </a>
          </li>
        </ul>
